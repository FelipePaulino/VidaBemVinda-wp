    ...
    <section>
      <div class="tratamento">
        <div class="gridD">
          ...
          <div class="left">
           <div class="player">
            <?php $video = get_post_meta($post->ID, 'deseja-exibir-o-video', true );
            $video_link = get_field('iframe_do_video');
            if ($video == 'sim') {
              echo
              "<iframe width=\"550\" height=\"309\" src=\"https://www.youtube.com/embed/$video_link\" frameborder=\"0\" gesture=\"media\" allow=\"encrypted-media\" allowfullscreen></iframe>";
            }
            else{
              echo "<iframe width=\"550\" height=\"309\" src=\"https://www.youtube.com/embed/myHxXmiFSzY\" frameborder=\"0\" gesture=\"media\" allow=\"encrypted-media\" allowfullscreen></iframe>";
            }
            ?>
          </div>
          <p><?php the_content(); ?></p>
  ...
  <section class="box-tratamentos">
    <div class="gridD">
      ...
      <div class="previa-tratamento">
        ...
        <p><?php echo rwmb_meta('tratamento');?></p>
