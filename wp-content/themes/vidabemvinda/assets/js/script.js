...
$(function(){
	...
	if(x < 480){
  		...
  		$(function(){
  			$('h2.doencas-footer').click(function(){ 
  				$('ul.doencas-lista').slideToggle();		
  			});
  			
});
  		$(function(){
  			$('h2.cirurgias-footer').click(function(){
  				$('ul.cirurgias-lista').slideToggle();		
  			});
  		});
  		$(function(){
  			$('h2.equipe-footer').click(function(){
  				$('ul.equipe-lista').slideToggle();		
  			});
  		});
