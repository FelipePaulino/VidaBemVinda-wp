      ...
      <div class="tratamento">
        <div class="gridD">
          <div class="title-page">
            <h2><span>Cirurgia de</span> <?php the_title(); ?></h2>
          ...
          <div class="left">
           ...
           <div class="more-informations"><div class="player"><iframe src="https://player.vimeo.com/video/202791609" width="550" height="309"  frameborder="0"></iframe></div></div>
          </div>
          <div class="right">
            ...
            <div class="related-posts">
              ...
              <p><?php echo rwmb_meta('introducao-tratamentos');?></p>
                 ...
                 <?php  
                    ...
                    // Name // 
                    echo  '<a href='. $value[2].'><h4>'. $value[0] .'</h4>'; 
                    // Email
                    echo '<p>'. $value[1]. '</p></a>'; 
                  }
                ?>
